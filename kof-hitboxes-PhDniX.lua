...
local boxes = {
	...
	["proj. vulnerability"] = {color = 0xFFFF00, fill = 0x00, outline = 0xFF},
	       ["proj. attack"] = {color = 0xFF4500, fill = 0x00, outline = 0xFF},
	               ["push"] = {color = 0x00FFFF, fill = 0x00, outline = 0xFF},
	              ["guard"] = {color = 0x00FF00, fill = 0x00, outline = 0xFF},
	              ["throw"] = {color = 0xFF00FF, fill = 0x00, outline = 0xFF},
	         ["axis throw"] = {color = 0xFFAAFF, fill = 0x00, outline = 0xFF}, --kof94, kof95
	          ["throwable"] = {color = 0xFFFFFF, fill = 0x00, outline = 0xFF},
	         ["impossible"] = {color = 0xAAAAFF, fill = 0x00, outline = 0xFF},
	         ["counterhit"] = {color = 0x3333FF, fill = 0x00, outline = 0xFF},
	         	   ["test"] = {color = 0xFF00FF, fill = 0x00, outline = 0xFF},
	         	    ["otg"] = {color = 0xAAAFF, fill = 0x00, outline = 0xFF},
}
...
local a,v,p,g,t,i,c,o,x = "attack","vulnerability","proj. vulnerability","guard","throw","impossible","counterhit","otg","test"
...
local profile = {
	...
	},
	{
		...
		box_types = {
			...
			c, --Countehrit head
			c, --Counterhit body
			v, --Startup and active of normals, head & limbs.
			v, --Startup and active of normals, body
			v, --Vulnerable box of juggles on the way down.
			v, --OTG
			g, --Guard
			g, --Guard point
			v, --?
	...
	},
	{
		...
		box_types = {
			...
			a, --Sweep
			a, --?
			a, --Several command normals (kyo f+B and df+B)
			a, --CD attacks
			a,
			a,
			a,
			...
			a,a,a,a,a,a,a,a,a,a,a,a,a,a,a,
			a,a,a,a,a,a,a,
			g, --Billy qcb+B (high counters?)
			g, --Bily qcb+D (low/mid counters?)
			p,p,p,p,p,p
		},
	},
	{
		...
		box_types = {
			v, --Vulnerable head
			v, --Vulnerable body
			c, --Counterhittable head
			c, --Counterhittable body
			v, --Startup and active of normals, head & limbs. Also: Striker vulnerability Head
			v, --Startup and active of normals, body Also: Striker vulnerability
			v, --Vulnerable box of juggles on the way down.
			o, --OTG box
			x, --?
			g, --Guard
			...
			a, --CD attacks
			a,a,a,a,a,
			i, --Anywhere juggle vunlerable box
			a,a,a,a,a,a,a,a,a,
			a,a,a,a,a,a,a,a,a,a,a,a,a,a,a,a,
			a,a,a,a,a,a,a,
			g, --Counterbox
	...
	},
	{
		...
		box_types = {
			...
			c, --Counterhit body
			v, --?
			v, --Crouching move startup/Normal jump attack startup (st.A of Ryo) all of Takuma's standing normals. No clear function.
			v, --?
			o, --OTG box
			v, --?
			g, --Guard
			...
			a, --Sweeps
			a, --?
			a, --Mostly overhead command normals: K'/Andy/Iori f+B but also: all but the last hit of Whip f+A,A,A,A
			a, --CD Attacks
			a, --Command normals: Andy df+A (first hit), Kyo f+B
			a, --?
			a, --Command normals: Kyo d+C, Mai d+A
			a, --Command normals: Mai d+B
			a, --?
			i, --Anywhere juggle vulnerable box
			a, --Mystery box, appears on Whip's hcb moves if I tag it with x, disappears without a trace if tagged with a.
			a, --?
			a, --?
			a, --?
			a, --Whip rdp+A (OTG projectiles? Strangely if tagged with a it shows up as a projectile attack (orange))
			a, --K' qcf+A attackbox (NOT qcf+C!)
			a, --Kusanagi qcf+P attackbox
			a, --First hit of K' dp+C
			a, --Iori hcb+K, Kusanagi hcb+K
			a, --?
			a, --?
			a, --?
			a, --First attack box of Kusanagi dp+C
			a, --?
			a, --?
			a, --?
			a, --Second hit of Kusanagi qcf+B,B
			a, --Second hit of Kusanagi qcf+D,D
			a, --?
			a, --First hit of Kusanagi qcf+K (unexpected! qcf+D can't juggle off a juggle ever, qcf+B can!)
			a, --?
			a, --?
			a, --?
			a, --?
			...
			a, --?
			a, --?
			a, --Hitgrab attackbox (also 2nd hit of hcf+A of whip, which is an anywhere juggle. So apparently is impossible to see when a move has anywhere juggle property)
			g, --High/mid counterbox (Billy high counter, Seth hcf+B)
			g, --2nd counterbox (see Yamazaki hcf+K) No idea what it does. Seth hcf+D and d,d+A
			p, --Majority of projectiles
			p, --?
			p, --?
			p, --?
			p, --?
		...
		--Vulnerable body, Vulnerable head, Counterhit body, Counterhit head, ?, CH crouch ?
	},
}
